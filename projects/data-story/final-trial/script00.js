...
enterView({    // special one to make it lightyellow (scorll back and get blue)
	selector: '.recolor',
	enter: function(el) {
...
enterView({     // special one to make it blue (scorll back and get lightyellow)
	selector: '.origcolor',
	enter: function(el) {
		console.log('a special element entered');
		console.log("Color")
...
enterView({   // special one to make it big (scorll back and get normal)
	selector: '.oversize',
	enter: function(el) {
		console.log('a special element entered');
		myData[0][2] = 300
...
enterView({   // special one to make it normal (scorll back and get normal)
	selector: '.minisize',
	enter: function(el) {
		console.log('a special element entered');
		myData[0][2] = 0
